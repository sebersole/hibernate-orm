...
/**
 * Implementation of {@link NaturalIdStorageAccess} that handles {@link NonStopCacheException} using
 * {@link HibernateNonstopCacheExceptionHandler}
 *
 * @author Abhishek Sanoujam
 * @author Alex Snaps
 */
public class NonstopAwareNaturalIdRegionAccessStrategy implements NaturalIdStorageAccess {
	private final NaturalIdStorageAccess actualStrategy;
	private final HibernateNonstopCacheExceptionHandler hibernateNonstopExceptionHandler;

	/**
	 * Constructor accepting the actual {@link NaturalIdStorageAccess} and the {@link HibernateNonstopCacheExceptionHandler}
	 *
	...
	public NonstopAwareNaturalIdRegionAccessStrategy(
			NaturalIdStorageAccess actualStrategy,

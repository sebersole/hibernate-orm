...
public class CollectionRegionAccessStrategyTest extends
		AbstractRegionAccessStrategyTest<CollectionRegionImpl, CollectionStorageAccess> {
	...
	@Override
	protected CollectionStorageAccess getAccessStrategy(CollectionRegionImpl region) {

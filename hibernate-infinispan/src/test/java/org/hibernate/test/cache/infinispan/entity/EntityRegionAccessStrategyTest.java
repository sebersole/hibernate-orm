...
public class EntityRegionAccessStrategyTest extends
		AbstractRegionAccessStrategyTest<EntityRegionImpl, EntityStorageAccess> {
	...
	@Override
	protected EntityStorageAccess getAccessStrategy(EntityRegionImpl region) {
	...
	protected void doInsert(EntityStorageAccess strategy, SharedSessionContractImplementor session, Object key, String value, Object version) {
	...
	protected void doUpdate(EntityStorageAccess strategy, SharedSessionContractImplementor session, Object key, Object value, Object version) throws javax.transaction.RollbackException, javax.transaction.SystemException {

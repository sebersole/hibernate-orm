...
[NOTE]
====
To use these hibernate-orm-spatial types just must add the `hibernate-orm-spatial` dependency to your classpath _and_ use a the `org.hibernate.spatial.SpatialDialect`.

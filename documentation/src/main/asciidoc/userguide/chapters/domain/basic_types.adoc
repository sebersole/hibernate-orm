...
how did Hibernate know to use its `org.hibernate.type.mapper.spi.basic.StringType` for mapping for `java.lang.String` attributes,
or its `org.hibernate.type.mapper.spi.basic.IntegerType` for mapping `java.lang.Integer` attributes?

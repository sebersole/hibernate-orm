...
For example, this might cause lead to issues with mismatches between an attribute mapped as a `org.hibernate.type.mapper.spi.basic.DateType` and an attribute defined as a `org.hibernate.type.mapper.spi.basic.TimestampType`,

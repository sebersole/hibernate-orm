...
One such example is a mismatch between a property defined as an `org.hibernate.type.mapper.spi.basic.DateType` and a property defined as an `org.hibernate.type.mapper.spi.basic.TimestampType`,

...
public class NewGeneratorMappingsTest extends BaseCoreFunctionalTestCase {
	...
	public void testMinimalTableEntity() {
		...
		assertEquals( TableGenerator.DEF_SEGMENT_COLUMN, tabGenerator.getSegmentColumnNameText() );
		assertEquals( "MINIMAL_TBL", tabGenerator.getSegmentValue() );
		assertEquals( TableGenerator.DEF_VALUE_COLUMN, tabGenerator.getValueColumnNameText() );

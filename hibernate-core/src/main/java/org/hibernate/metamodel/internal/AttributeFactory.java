...
public class AttributeFactory {
	...
	private <X, Y> AttributeMetadata<X, Y> determineAttributeMetadata(
		...
		final org.hibernate.type.mapper.spi.Type type = value.getType();
		...
		if ( type.isAnyType() ) {
			...
			if ( value instanceof Collection ) {
				...
				final org.hibernate.type.mapper.spi.Type elementType = elementValue.getType();
				...
				if ( value instanceof Map ) {
					...
					final org.hibernate.type.mapper.spi.Type keyType = keyValue.getType();
...
//		throw new IllegalArgumentException( "Unexpected type [" + declaredType + "]" );
	...
	private final MemberResolver virtualIdentifierMemberResolver = new MemberResolver() {
		...
		public Member resolveMember(AttributeContext attributeContext) {
			...
			org.hibernate.type.mapper.spi.Type type = entityMetamodel.getIdentifierProperty().getType();

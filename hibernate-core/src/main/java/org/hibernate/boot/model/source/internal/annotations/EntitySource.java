 ...
 */
public interface EntitySource extends IdentifiableTypeSource, EntityNamingSourceContributor {
	/**
	...
	/**
	 * Retrieve the name of the {@link org.hibernate.tuple.entity.EntityTuplizer} implementor
	 ...
	 */
	Collection<ConstraintSource> getConstraints();

...
import org.hibernate.annotations.AutoQueryImport;
...
import org.hibernate.annotations.LocalDefaults;
import org.hibernate.annotations.ManyToAny;
import org.hibernate.annotations.MapKeyType;
import org.hibernate.annotations.MetaValue;
import org.hibernate.annotations.MultiTenancy;
...
import org.hibernate.annotations.QueryImport;
import org.hibernate.annotations.QueryImports;
...
import org.hibernate.annotations.TenantColumn;
import org.hibernate.annotations.TenantFormula;
...
public interface HibernateDotNames {
	...
	DotName AUTO_QUERY_IMPORT = DotName.createSimple( AutoQueryImport.class.getName() );
	...
	DotName COLLECTION_TYPE = DotName.createSimple( CollectionType.class.getName() );
	...
	DotName LIST_INDEX_BASE = DotName.createSimple( ListIndexBase.class.getName() );
	DotName LOADER = DotName.createSimple( Loader.class.getName() );
	DotName LOCAL_DEFAULTS = DotName.createSimple( LocalDefaults.class.getName() );
	...
	DotName MULTI_TENANT = DotName.createSimple( MultiTenancy.class.getName() );
	...
	DotName OPTIMISTIC_LOCKING = DotName.createSimple( OptimisticLocking.class.getName() );
	DotName OPTIMISTIC_LOCK_TYPE = DotName.createSimple( OptimisticLockType.class.getName() );
	...
	DotName POLYMORPHISM = DotName.createSimple( Polymorphism.class.getName() );
	DotName PROXY = DotName.createSimple( Proxy.class.getName() );
	DotName ROW_ID = DotName.createSimple( RowId.class.getName() );
	DotName QUERY_IMPORT = DotName.createSimple( QueryImport.class.getName() );
	DotName QUERY_IMPORTS = DotName.createSimple( QueryImports.class.getName() );
	...
	DotName TENANT_COLUMN = DotName.createSimple( TenantColumn.class.getName() );
	DotName TENANT_FORMULA = DotName.createSimple( TenantFormula.class.getName() );

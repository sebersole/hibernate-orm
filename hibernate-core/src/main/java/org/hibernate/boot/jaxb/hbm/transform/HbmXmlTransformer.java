...
//		}
	...
	private JaxbManyToOneImpl transformManyToOne(final JaxbHbmManyToOneType hbmM2O) {
	...
	private JaxbManyToManyImpl transformManyToManyCollection(PluralAttributeInfo pluralAttributeInfo) {
		throw new MappingException( "ManyToMany transformation not yet implemented", origin );
	}

	private JaxbPluralAnyMappingImpl transformManyToAnyCollection(PluralAttributeInfo pluralAttributeInfo) {
		throw new MappingException( "ManyToAny transformation not yet implemented", origin );
	}

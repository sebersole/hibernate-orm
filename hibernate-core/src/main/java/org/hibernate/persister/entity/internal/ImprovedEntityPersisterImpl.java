...
public class ImprovedEntityPersisterImpl implements ImprovedEntityPersister, EntityType {
	...
	public void finishInitialization(
		...
		for ( int attributeNumber = 0; attributeNumber < fullAttributeCount; attributeNumber++ ) {
			...
			final org.hibernate.type.mapper.spi.Type attributeType = ojlPersister.getSubclassPropertyType( attributeNumber );
	...
	@Override
	public org.hibernate.type.mapper.spi.Type getOrmType() {

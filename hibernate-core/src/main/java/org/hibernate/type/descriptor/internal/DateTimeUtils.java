...
public final class DateTimeUtils {
	...
	public static TemporalAccessor parseTemporalAccessorFromTimestamp(String timestamp) {
		return DATE_TIME_FORMATTER_TIMESTAMP.parse( timestamp );
	}

	public static TemporalAccessor parseTemporalAccessorFromDate(String date) {
		return DATE_TIME_FORMATTER_DATE.parse( date );
	}

	public static TemporalAccessor parseTemporalAccessorFromTime(String time) {
		return DATE_TIME_FORMATTER_TIME.parse( time );
	}
	...
	public static Date parseDateFromDate(String string) {
		try {
			return simpleDateFormatDate().parse( string );
		}
		catch (ParseException e) {
			throw new HibernateException( "Unable to parse string literal as Date", e );
		}
	}

	public static Date parseDateFromTime(String string) {
		try {
			return simpleDateFormatTime().parse( string );
		}
		catch (ParseException e) {
			throw new HibernateException( "Unable to parse string literal as Date", e );
		}
	...
	public static Date parseDateFromTimestamp(String string) {
		try {
			return simpleDateFormatTimestamp().parse( string );
		}
		catch (ParseException e) {
			throw new HibernateException( "Unable to parse string literal as Date", e );
		}

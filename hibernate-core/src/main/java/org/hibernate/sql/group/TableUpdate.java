...
/**
 * Models an update to a table
 *
 * @author Steve Ebersole
 */
public class TableUpdate extends AbstractValuedTableMutation implements RestrictedTableMutation {
	...
	public TableUpdate(
		...
		super(
				...
				primaryTableIndex,
				tableIndexes,
				valuesColumnParamIndexMap,
				valuesKeyColumnParamIndexMap
		);

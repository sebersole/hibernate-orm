		...
		if ( metadata != null ) {
			if ( globalDefaults == null ) {
				...
				if ( defaultElement != null ) {
					ifNotNull( defaultElement.getSchema(), globalDefaults::setSchema );
					ifNotNull( defaultElement.getCatalog(), globalDefaults::setCatalog );
					ifNotNull( defaultElement.getAccess(), globalDefaults::setAccess );

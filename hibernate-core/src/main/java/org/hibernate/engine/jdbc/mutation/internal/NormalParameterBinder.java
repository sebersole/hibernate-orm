 ...
 */
public class NormalParameterBinder implements ParameterBinderImplementor {
	private final PreparedStatementGroup statementGroup;

	public NormalParameterBinder(PreparedStatementGroup statementGroup) {
		if ( MUTATION_EXEC_TRACE_ENABLED ) {
			MUTATION_EXEC_LOGGER.trace( "Using as-is parameter binding for mutation execution" );
		}

...
2. name the "task path".  For example, in order to run the tests for the _hibernate-orm_ module from the root directory you could say `gradle hibernate-orm:test`

Common Java related tasks
-------------------------

* _build_ - Assembles (jars) and tests this project
* _buildDependents_ - Assembles and tests this project and all projects that depend on it.  So think of running this in hibernate-orm, Gradle would assemble and test hibernate-orm as well as hibernate-envers (because envers depends on core)
